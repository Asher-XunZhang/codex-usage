...
from test_token_usage import meta, start, record
...
class BudgetHostReaderTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        source = (ROOT / 'Sources/BudgetHost.swift').read_text()
        ...
        for command in [
            ['xcrun', 'clang', '-Os', str(ROOT / 'Sources/Summary.c'), '-lsqlite3', '-o', str(folder / 'CodexSummary')],
