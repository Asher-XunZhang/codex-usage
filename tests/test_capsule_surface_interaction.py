...
''')
        ...
        result = subprocess.run(['xcrun', 'swiftc', '-swift-version', '5', str(main), str(source_root / 'Capsule.swift'), str(source_root / 'CapsuleHost.swift'), '-o', str(cls.binary)], capture_output=True, text=True, timeout=120)
