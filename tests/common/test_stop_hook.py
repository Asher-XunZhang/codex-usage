...
spec = importlib.util.spec_from_file_location("stop_hook", ROOT / "integrations/codex-token-usage/scripts/stop_hook.py")
...
class StopHookTests(unittest.TestCase):
    def test_optional_skill_uses_the_same_accounting_parser(self):
        self.assertEqual((ROOT / "integrations/codex-token-usage/scripts/token_usage.py").read_bytes(),
                         (BACKEND / 'token_usage.py').read_bytes())
