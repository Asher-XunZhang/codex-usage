...
select_release() {
    ...
    case "$architecture" in
        arm64)
            label=AppleSilicon
            expected_sha=30579a3dd8dd876aac5946f51dd95adbb42340ce2d4e773439216d4bd96b481d
            ;;
        x86_64)
            label=Intel
            expected_sha=5ccbe975ff3524037bb9a3177225fcdb4c8f82028210b9ac770d599a6ff0709f
            ;;
