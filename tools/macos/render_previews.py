...
def main(argv=None, *, legacy=False):
    ...
    parser.add_argument('--source', type=Path, default=macos_source('Capsule.swift'))
    parser.add_argument('--output', type=Path, default=ROOT / ('.local/previews' if legacy else 'build/previews/macos'))
    ...
    fixture = ROOT / 'tools/macos/preview/main.swift'
