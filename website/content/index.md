---
title: 用量、提醒与桌面陪伴
description: 下载 Windows v1.0.3 或 macOS v1.0.3，查看用量、预算提醒、任务监控及四边贴合浮窗。
outline: false
---
...
<div class="docs-hero">
  ...
  <h1>看清用量，安心做事</h1>
  <p class="intro">在桌面查看 Codex 的本机 Token 记录与账号剩余额度。两端都能设置预算提醒、关注正在执行的任务，在一轮结束时收到提示。</p>
</div>
...
<a class="primary" href="https://github.com/Asher-XunZhang/codex-usage/releases/download/v1.0.3/codex-usage-desktop-v1.0.3-windows-x64.zip">下载 Windows ZIP</a>
</div>
...
| 你在做什么 | Windows v1.0.3 | macOS v1.0.3 |
| --- | --- | --- |
| 复盘用量 | 主面板的趋势、筛选与明细 | 主面板的趋势、筛选与明细 |
| 专心工作，偶尔看一眼 | 系统托盘悬停摘要、单击详情卡 | 屏幕顶部菜单栏 |
| 在桌面保留额度 | 圆环、四边隐藏侧签、可拖动展开面板 | 圆环、四边侧签、连续形变与整窗拖动 |
| 等待任务完成 | 应用内标记与可选 Windows 系统通知 | 应用内标记与可选 macOS 系统通知 |
...
<p class="docs-version">Windows：v1.0.3 / x64。macOS：v1.0.3 / Intel 与 Apple Silicon，最低构建目标 macOS 11。系统目标与实际验收范围见验证页。</p>
